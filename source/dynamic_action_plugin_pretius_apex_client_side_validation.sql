...
'    END LOOP; ',
'  END IF; ',
'  VR_STR := APEX_PLUGIN_UTIL.REPLACE_SUBSTITUTIONS( P_VALUE => VR_STR, ',
'                                                   P_ESCAPE => TRUE); ',
'  APEX_DEBUG.ERROR(VR_STR);',
'  RETURN VR_STR; ',
'END PERFORM_BINDS; ',
